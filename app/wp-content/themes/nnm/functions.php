...
function custom_unixtimesamp ( $post_id ) {
    ...
    $startdate = get_post_meta($post_id, 'fecha', true);
        ...
        if($startdate) {
            ...
            $mes = $dateparts[1];
            $dia = $dateparts[2];
            update_post_meta($post_id, 'anho-agenda', $anho  );
            update_post_meta($post_id, 'mes-agenda', $mes  );
            update_post_meta($post_id, 'dia-agenda', $dia  );
        }
